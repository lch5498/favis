...
const faqs = [
  {
    ...
    description:
      '네. 체키는 가족 단위로 일정과 주차 정보를 관리합니다. 로그인 후 가족을 만들고 구성원을 등록하면 일정, 반복 일정, 주차 기능을 사용할 수 있습니다.',
  },
  {
    title: '반복 일정은 캘린더에 자동 반영되나요?',
    description:
      '반복 일정을 등록하면 설정한 기간과 요일, 시간에 맞춰 캘린더 일정이 자동으로 생성됩니다.',
  },
  {
